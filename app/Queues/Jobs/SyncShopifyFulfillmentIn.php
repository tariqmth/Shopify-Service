...
class SyncShopifyFulfillmentIn implements ShouldQueue, SyncJob
{
    ...
    public function __construct(
        ...
        $this->shopifyFulfillmentData = $shopifyFulfillmentData;
    ...
    {
        try {
            $syncer->performSyncIn($this->shopifyFulfillmentId, $this->shopifyFulfillmentData);
